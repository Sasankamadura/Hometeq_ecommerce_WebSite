...
if (empty($email) or empty($password)) //if either the $email or the $password is empty 
    ...
    $exeSQL = mysqli_query($connection, $SQL) or die (mysqli_error($connection)); //execute SQL query
    ...
    $_SESSION['userid'] = $arrayuser['userld']; //create session variable to store the user id
